...
* **Active USB Connection Monitoring**: Instantly detects and displays connection status (🔴 Disconnected / 🟢 Connected) in the header. Controls are automatically locked unless an iPhone or iPad is connected, preventing empty connection exceptions from occurring.
